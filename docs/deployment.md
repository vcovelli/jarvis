...
| Variable | Default | Purpose |
| --- | --- | --- |
| `HOMELAB_DOCS_ROOT` | `/home/developer/homelab-docs` | Readable root for the in-app Markdown browser and snapshots. |
| `PROMETHEUS_BASE_URL` | `http://127.0.0.1:9090` | Prometheus endpoint queried by the server. |
| `GRAFANA_BASE_URL` | `http://192.0.2.3:3001` | Base link shown for Grafana. |
